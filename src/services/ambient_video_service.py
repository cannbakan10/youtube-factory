...
class AmbientVideoService:
    ...
    AMBIENT_PRESETS: Dict[str, Dict[str, object]] = {
        "fireplace": {
            ...
            "video_keywords": ["cat sleeping fireplace", "cozy cat fire", "cat fireplace cozy", "sleeping cat warm", "fireplace burning cozy"],
            "audio_queries": ["fireplace crackling ambience", "fire crackling slow"],
            "fallback_noise_color": "brown",
            "fallback_bg_color": "0x2B1208",
        },
        "cat_fireplace": {
            "title": "Cozy Cat by the Fireplace — Purring & Crackling Fire for Sleep",
            "description": "Watch a cozy cat sleep peacefully by a warm fireplace. Perfect for relaxation, sleep, and stress relief. Hours of purring and crackling fire sounds.",
            "tags": ["cat fireplace", "sleeping cat", "cozy cat", "purring cat", "fireplace ambience", "cat asmr", "relaxing cat", "cat purring sleep"],
            "video_keywords": ["cat sleeping fireplace", "cozy cat fire", "cat fireplace cozy", "sleeping cat warm fire", "kitten fireplace"],
            "audio_queries": ["cat purring fireplace", "cat purring crackling fire"],
            "fallback_noise_color": "brown",
            "fallback_bg_color": "0x2B1208",
        },
        "sleep": {
